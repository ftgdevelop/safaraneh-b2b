...
const DomesticHotelListSideBar: React.FC<Props> = props => {
    ...
    return (
        <>
            ...
            <div
                className={`${isSafarLife?"":"bg-white rounded-xl border"} max-lg:fixed max-lg:max-w-full max-lg:w-72 z-20 max-lg:overflow-auto top-0 max-lg:h-screen rtl:right-0 transition-all
