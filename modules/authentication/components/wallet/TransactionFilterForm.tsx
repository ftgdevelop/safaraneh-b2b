      ...
      {({ errors, touched, isValid, isSubmitting, setFieldValue, values }) => {
        ...
        return (
          <Form autoComplete="off">
            <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-[repeat(auto-fill,minmax(160px,1fr))] gap-4 mb-5 items-end">
              <FormikField
                labelIsSimple
                ...
                onChange={(value: string) => {
                  setFieldValue("ReserveId", value, true);
                }}
              ...
              <div>
                ...
                <Select
                  onChange={(e) => {
                    setFieldValue("PaymentType", e, true);
                  }}
              ...
              <div className="xl:col-span-3">
                ...
                <Select
                  onChange={(e) => {
                    setFieldValue("TransferType", e, true);
                  }}
                  ...
                  items={[
                    ...
                    {
                      value: "OnlineManualRefund",
                      label: "استرداد دستی آنلاین",
                    },
                    {
                      value: "IncreaseDepositByPaymentGateway",
                      label: "افزایش موجودی از طریق درگاه پرداخت",
                    },
                    {
                      value: "DecreaseDepositBySale",
                      label: "کاهش موجودی با فروش",
                    },
                    {
                      value: "IncreaseDepositByRefund",
                      label: "افزایش موجودی با استرداد",
                    },
                    {
                      value: "IncreaseDepositByReverse",
                      label: "افزایش موجودی با برگشت",
                    },
                    {
                      value: "DecreaseDepositByWithdraw",
                      label: "کاهش موجودی با برداشت",
                    },
                    {
                    ...
                    {
                      value: "ManualIncreaseDeposit",
                      label: "افزایش موجودی دستی",
                    },
                    {
                      value: "ManualDecreaseDeposit",
                      label: "کاهش موجودی دستی",
                    },
                    {
                      value: "ManualIncreaseDepositByRefund",
                      label: "افزایش موجودی دستی از طریق استرداد",
                    },
                  ]}
                />
              </div>
              ...
              <div>
                ...
                <Select
                  onChange={(e) => {
                    setFieldValue("CurrencyType", e, true);
                  }}
