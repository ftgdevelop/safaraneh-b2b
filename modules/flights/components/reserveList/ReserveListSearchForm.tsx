                ...
                return (
                    ...
                    <Form className='grid grid-cols-1 gap-3 mb-6' autoComplete='off' >
                        ...
                        <SimpleRangePicker
                            name='checkin'
                            label='تاریخ پرواز'
                            value={[values.DepartureTimeFrom, values.DepartureTimeTo]}
                            onChange={a => {
                                if (a.value[0] && a.value[1]) {
                                    setFieldValue("DepartureTimeFrom", a.value[0]);
                                    setFieldValue("DepartureTimeTo", a.value[1]);
                                }
                            }}
                            rtl
                            locale={localeFa}
                        ...
                        <Button
                            ...
                            onClick={() => {
                                ...
                                setFieldValue('DepartureTimeFrom', "");
                                setFieldValue('DepartureTimeTo', "");
