...
import { Bed, Calendar, DefaultRoom, Directions, Email, Hotel, Location, Lock, Phone, RightCaret, Tik, User } from '@/modules/shared/components/ui/icons';
                            ...
                            <div className='border border-neutral-300 bg-white rounded-xl'>
                                ...
                                <div className='p-4'>
                                    ...
                                    <div className='flex flex-col md:flex-row gap-y-1 gap-x-10 text-xs text-blue-800 font-semibold md:items-center'>
                                        ...
                                        {phoneNumber && <div className='flex gap-2 items-center'>
                                            <Phone className='w-5 h-5 fill-current' />
                                            <a href={`tel:${phoneLink}`}>{phoneNumber}</a>
                                        </div>}
                                        {email && <div className='flex gap-2 items-center'>
