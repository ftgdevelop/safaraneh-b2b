...
import { CreditCard, ErrorCircle, LeftCaret, RightCaret } from "@/modules/shared/components/ui/icons";
...
const OfflineTransactions: NextPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchTransactions = async (params: {
            ...
            const response: any = await getManualReceiptTransactions(parameters, tenant, token);
                    ...
                    <table className="w-full text-sm text-neutral-700">
                        <thead>
                            <tr className="text-muted-foreground">
                                ...
                                <th className={`${tableCellClass} w-16 xl:w-40 `}> تاریخ تراکنش </th>
